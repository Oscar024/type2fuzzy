...
from type2fuzzy.membership.generatet2mf import generate_gt2set
...
class GeneralType2FuzzySet:
	...
	@classmethod
	def from_gafa_representation(cls, primary_domain, secondary_domain, set_def):
		'''
		...
		gt2fs -- GeneralType2FuzzySet
		'''
		set_array = generate_gt2set(primary_domain, secondary_domain, set_def)
