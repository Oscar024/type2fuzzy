...
class TestGeneralType2FuzzySet(unittest.TestCase):
	...
	def test_to_representation(self):
		...
		# str_set = gt2fs.to_representation(num_dec_places=2)
		# expected_set = '(0.90 / 0.00 + 0.50 / 0.50 + 0.30 / 0.90) / 1.00 + (0.00 / 0.00 + 1.00 / 0.50 + 0.60 / 0.90) / 2.00 + (0.00 / 0.00 + 0.00 / 0.50 + 1.00 / 0.90) / 3.00'
